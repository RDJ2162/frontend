  ...
  function(ko, Context, moduleUtils, KnockoutTemplateUtils, CoreRouter, ModuleRouterAdapter, KnockoutRouterAdapter, UrlParamAdapter, ResponsiveUtils, ResponsiveKnockoutUtils, ArrayDataProvider) {
     ...
     function ControllerViewModel() {
      ...
      let navData = [
        ...
        { path: 'transactions', detail: { label: 'Transactions', iconClass: 'oj-ux-ico-information-s' } }
      ];
      let fullRouterConfig  = [
         { path: '', redirect: 'dashboard' },
         { path: 'transactionById', detail: { label: 'Transaction Details'} },
         { path: 'addupdatecustomer', detail: { label: 'Transaction Details'} },
         ...navData
      ];
      // let navData = [
      //   // { path: '', redirect: 'dashboard' },
      ...
      // Router setup
      let router = new CoreRouter(fullRouterConfig , {
